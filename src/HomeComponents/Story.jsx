...
const Story = ({ story }) => {
    ...
    return (
        <div className="flex flex-col md:flex-row md:items-start lg:items-center items-center text-center md:text-start gap-7 font-spinnaker border border-amber-200 bg-amber-50 mb-5 p-5 md:p-7 rounded-3xl">
